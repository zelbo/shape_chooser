...
state_election_results = os.path.join(merge_path, "state_results.csv")
county_election_results = os.path.join(merge_path, "county_results.csv")
state_glue_file = os.path.join(merge_path, "merge_state.csv")
county_glue_file = os.path.join(merge_path, "merge_county.csv")
...
shape_df = strip_territories.strip(shape_df)
